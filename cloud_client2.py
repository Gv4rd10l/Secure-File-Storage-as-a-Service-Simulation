...
def run():
    with grpc.insecure_channel('localhost:50051') as channel:
        ...
        def request_generator():
            """Envoie des entrées utilisateur au serveur."""
            while True:
                user_input = input()
...
def secu(run, crypto, private_key, pem_public_key):
    ...
    gvardiol_certif_pepe={"machine_name":"machine_cliente_gvardiol", "entreprise_name":"gvardiol_client", "serial_number":"8563GJG90", "valide":"09/01/25", "domain":"pepecloud.com", "public_cypher_key":"jeukshtrfrk5674fdhn90klz"}
    ...
    def check_certif(gvardiol_certif, auth_user):
        ...
        try:
            with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as client_socket:
                ...
                data_to_send = pickle.dumps(gvardiol_certif)
    ...
    check_certif(gvardiol_certif_pepe, auth_user)
