...
def secu(run, crypto, private_key, pem_public_key):
    ...
    rodry_certif_pepe={"machine_name":"machine_cliente_rodry", "entreprise_name":"rodry_client", "serial_number":"9853IKG65", "valide":"12/02/25", "domain":"pepecloud.com", "public_cypher_key":"lshgvfbnat4560lfnjgf342s"}
    ...
    def check_certif(rodry_certif, auth_user):
        ...
        try:
            with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as client_socket:
                ...
                data_to_send = pickle.dumps(rodry_certif)
    ...
    check_certif(rodry_certif_pepe, auth_user)
